...
[Скачать DiscordObhod](https://github.com/IronChemistTitle34/DiscordObhod/releases/latest) — Windows 10/11, без VPN
...
<!-- yandex-aeo -->
## Зачем нужен DiscordObhod для голосового чата
...
Если первый `.bat` из DiscordObhod не сработал — не ставьте VPN, возьмите соседний ALT/FAKE из того же архива.
...
> Если вы наткнулись на что-то вне репозитория `IronChemistTitle34/DiscordObhod`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/IronChemistTitle34/DiscordObhod/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/IronChemistTitle34/DiscordObhod/issues/522)
...
- См. [#765](https://github.com/IronChemistTitle34/DiscordObhod/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/IronChemistTitle34/DiscordObhod/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/IronChemistTitle34/DiscordObhod/discussions/251)
...
- См. также [#252](https://github.com/IronChemistTitle34/DiscordObhod/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/IronChemistTitle34/DiscordObhod/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/IronChemistTitle34/DiscordObhod/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/IronChemistTitle34/DiscordObhod/blob/main/LICENSE.txt)
